...
new \sowerphp\general\View_Helper_Table([
    ...
    [$col++, 'F', 'RznSocRecep', 'Razón social receptor', '', '100', 'Opcional sólo en boletas no nominativas'],
    [$col++, 'G', 'GiroRecep', 'Giro del receptor', '', '40', 'Opcional sólo en boletas'],
    ...
    [$col++, 'J', 'DirRecep', 'Dirección del receptor', '', '70', 'Opcional sólo en boletas'],
    [$col++, 'K', 'CmnaRecep', 'Comuna del receptor', 'Sin abreviaciones, tal como se ve en LibreDTE', '20', 'Opcional sólo en boletas'],
    [$col++, 'L', 'VlrCodigo', 'Código del ítem', '', '35', 'Opcional'],
    [$col++, 'M', 'IndExe', 'Exento', 'Si el ítem es exento se debe indicar un 1 (uno) en este campo', '1', 'Opcional'],
