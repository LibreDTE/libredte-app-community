...
new \sowerphp\general\View_Helper_Table([
    ...
    [$col++, 'F', 'RznSocRecep', 'Razón social receptor', '', '100', 'Opcional solo en boletas'],
    [$col++, 'G', 'GiroRecep', 'Giro del receptor', '', '40', 'Opcional solo en boletas'],
    ...
    [$col++, 'J', 'DirRecep', 'Dirección del receptor', '', '70', 'Opcional solo en boletas'],
    [$col++, 'K', 'CmnaRecep', 'Comuna del receptor', 'Sin abreviaciones, tal como se ve en LibreDTE', '20', 'Opcional solo en boletas'],
