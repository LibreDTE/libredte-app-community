        ...
        if (this.status == 200) {
            ...
            try {
                ...
                socket.onerror=function(event){
                    Form.alert('<p>No fue posible enviar a imprimir desde LibreDTE porque no se logró conectar con el servidor de impresión.</p><p>Para imprimir desde LibreDTE se debe descargar y ejecutar en el computador el software Websocketd Printer que permitirá imprimir directo desde LibreDTE sin tener que descargar el documento.</p><div class="row"><div class="col-md-4"><a href="https://www.sasco.cl/shop/websocketd-printer-windows-65?category=17" class="btn btn-primary"><i class="fa-brands fa-windows fa-fw fa-3x mb-4"></i><br/>Obtener Websocketd Printer para Windows</a></div><div class="col-md-4"><a href="https://www.sasco.cl/shop/websocketd-printer-mac-71?category=17" class="btn btn-primary"><i class="fa-brands fa-apple fa-fw fa-3x mb-4"></i><br/>Obtener Websocketd Printer para macOS</a></div><div class="col-md-4"><a href="https://www.sasco.cl/shop/websocketd-printer-linux-67?category=17" class="btn btn-primary"><i class="fa-brands fa-linux fa-fw fa-3x mb-4"></i><br/>Obtener Websocketd Printer para GNU/Linux</a></div></div>');
                }
            } catch(e) {
                console.log(e);
            }
