...
abstract class Model_Base_Libro extends Model_Base_Envio
{
    ...
    private function actualizarEstadoWebservice($user_id = null)
    {
        ...
        if (!$Firma) {
            throw new \Exception('No hay firma electrónica asociada a la empresa (o bien no se pudo cargar). Debe agregar su firma antes de actualizar el estado del libro. [faq:174]');
        }
