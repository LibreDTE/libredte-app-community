...
<div class="alert alert-warning">
    El monto de retención y monto líquido mostrados en esta funcionalidad solo consideran la tasa de retención base del período. No se considera la tasa adicional que pueda tener el receptor. Por ejemplo, por el préstamo del SII (tasa adicional del 3%). En la plataforma <a href="https://contafi.cl" target="_blank" class="alert-link">ContaFi</a> esto está resuelto.
</div>
<script>
