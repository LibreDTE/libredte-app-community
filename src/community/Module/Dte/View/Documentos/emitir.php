...
<div class="card mb-4">
    ...
    <div class="card-body">
        <?php if ($Emisor->puedeAsignarFolio($user)) : ?>
            <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-2 mb-2"><?=$f->input(['name' => 'CdgVendedor', 'placeholder' => 'Código vendedor', 'popover' => 'Código del usuario emisor asociado a la creación del documento. Este valor será informado al SII y registrado en el XML y PDF del documento.', 'value' => !empty($datos['Encabezado']['Emisor']['CdgVendedor']) ? $datos['Encabezado']['Emisor']['CdgVendedor']:$user->usuario, 'check' => 'notempty', 'attr' => 'maxlength="60"'])?></div>
