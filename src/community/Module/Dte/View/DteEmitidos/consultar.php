...
<div class="container">
    ...
    <div class="row">
        <div class="offset-md-3 col-md-6">
            ...
            <?php $f = new \sowerphp\general\View_Helper_Form(false); ?>
            ...
            <?php else: ?>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <h1 class="text-center mb-4">
                            <?=$DteEmitido->getTipo()->tipo?> #<?=$DteEmitido->folio?><br/>
                            <small><?=$DteEmitido->getEmisor()->getNombre()?></small>
                        </h1>
                        <?php
                ...
                <p class="text-center small">
                    <a href="<?=$_base.$_request?>">buscar otro documento</a>
                </p>
            <?php endif; ?>
        </div>
    </div>
